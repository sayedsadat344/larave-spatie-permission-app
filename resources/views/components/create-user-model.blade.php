...
<div>
    <div wire:ignore.self class="modal fade" id="createUser" data-bs-backdrop="static" data-bs-keyboard="false"
        tabindex="-1" aria-labelledby="createUserLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="createUserLabel">{{ $isUpdateOperation ? 'Edit User' : 'Add User' }}</h5>
                    ...
                    <form>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="button" class="btn btn-primary" wire:click="storeUser">
          ...
          <button type="button" class="btn btn-primary" wire:click="storeUser">Understood</button>
        </div> --}}
            </div>
        </div>
    </div>
